    ...
    : CustomControl(parent)
{
    ...
    m_highlightContainer->setHorizontalAlignment(HorizontalAlignment::Center);
    ...
    m_dateLabel = Label::create().text(" ");
    m_dateLabel->setHorizontalAlignment(HorizontalAlignment::Center);
    m_dateLabel->textStyle()->setBase(SystemDefaults::TextStyles::subtitleText());

    m_textArea = TextArea::create().text(" ");
    m_textArea->setVerticalAlignment(VerticalAlignment::Center);
